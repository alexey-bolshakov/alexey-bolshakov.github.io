...
module.exports = "<div class=\"video\">\n  <div class=\"content\">\n    <button class=\"reposition\">Reposition <img src=\"assets/images/reposition.png\" /></button>\n    <div class=\"player\">\n      <img src=\"assets/images/player.png\" />\n      <label class=\"add-subtitle\">click here to add subtitle</label>\n    </div>\n  </div>\n  <div class=\"options\">\n    <select>\n      <option>Helvetica</option>\n      <option>Helvetica Bold</option>\n      <option>Helvetica Medium</option>\n    </select>\n    <select class=\"font-sizes\">\n      <option>100.3</option>\n    </select>\n    <div class=\"separator\"></div>\n    <div class=\"btn-toolbar background\">&nbsp;</div>\n    <div class=\"btn-toolbar foreground\">A</div>\n    <div class=\"separator\"></div>\n    <div class=\"btn-toolbar bold\">B</div>\n    <div class=\"btn-toolbar italic\">I</div>\n    <div class=\"separator\"></div>\n    <div class=\"btn-toolbar spaceing\">Spaceing</div>\n  </div>\n  <div class=\"sizes\">\n    <div class=\"types\">\n      <label>Video Size</label>\n      <button class=\"btn-outline nine-sixteen\">9.16</button>\n      <button class=\"btn-outline one-one\">1.1</button>\n      <button class=\"btn-outline active sixteen-nine\">16.9</button>\n    </div>\n    <button class=\"complete\" *ngIf=\"subtitles.length > 0\" (click)=\"showCompleteModal()\"><i class=\"fa fa-eye\"></i>&nbsp;complete</button>\n  </div>\n</div>\n<div class=\"subtitles\">\n  <div class=\"video-options\">\n    <h2>Add Subtitles to Video</h2>\n    <div class=\"actions\">\n      <button class=\"play\"><i class=\"fa fa-play\"></i></button>\n      <button class=\"reload\"><i class=\"fa fa-undo\"></i></button>\n      <button>-5s</button>\n      <button>+5s</button>\n      <span class=\"running\">{{ currentPlay | videotime }} / {{ videoTime | videotime }}</span>\n    </div>\n    <p-slider [min]=\"0\" [max]=\"100\" [(ngModel)]=\"val\" styleClass=\"slider-width transparent\"></p-slider>\n  </div>\n  <div class=\"content\">\n    <div class=\"subtitle\" *ngFor=\"let subtitle of subtitles\">\n      <div class=\"title\">\n        <input type=\"text\" placeholder=\"click here to add subtitle\" />\n        <button class=\"btn-icon\" (click)=\"deleteSubtitle(subtitle.id)\">\n          <img src=\"/assets/images/trash.png\" />\n        </button>\n      </div>\n      <p-slider [min]=\"0\" [max]=\"videoTime\" [range]=\"true\" [(ngModel)]=\"subtitle.time\" styleClass=\"slider-width\"></p-slider>\n      <div class=\"period\">\n        <div class=\"start\">\n          <div class=\"time\">{{ subtitle.time[0] | videotime }}</div>\n          <label>Start Time</label>\n        </div>\n        <div class=\"divider\">-</div>\n        <div class=\"end\">\n          <div class=\"time\">{{ subtitle.time[1] | videotime }}</div>\n          <label>Start End</label>\n        </div>\n      </div>\n    </div>\n    <div class=\"subtitle-add\">\n      <div class=\"subtitle disabled\">\n        <div class=\"title\">\n          <input type=\"text\" placeholder=\"Click here to add subtitle\" />\n          <button class=\"btn-icon\">\n            <img src=\"/assets/images/trash.png\" />\n          </button>\n        </div>\n        <p-slider [min]=\"0\" [max]=\"videoTime\" [range]=\"true\" [(ngModel)]=\"defaultRange\" styleClass=\"slider-width\"></p-slider>\n        <div class=\"period\">\n          <div class=\"start\">\n            <div class=\"time\">{{ defaultRange[0] | videotime }}</div>\n            <label>Start Time</label>\n          </div>\n          <div class=\"divider\">-</div>\n          <div class=\"end\">\n            <div class=\"time\">{{ defaultRange[1] | videotime }}</div>\n            <label>Start End</label>\n          </div>\n        </div>\n      </div>\n      <button class=\"btn-add\" (click)=\"addSubtitle()\">Add Another Subtitle</button>\n    </div>\n  </div>\n</div>\n\n<div class=\"complete-modal\" *ngIf=\"isShowCompleteModal\">\n  <div class=\"modal-header\">\n    <div class=\"actions\">\n      <button><i class=\"fa fa-download\"></i>download</button>\n      <button (click)=\"closeCompleteModal()\"><i class=\"fa fa-times-circle\"></i></button>\n    </div>\n  </div>\n  <div class=\"player\">\n    <img src=\"assets/images/player.png\" />\n    <label class=\"add-subtitle\">click here to add subtitle</label>\n  </div>\n</div>\n"
...
module.exports = ":host {\n  display: flex;\n  flex-direction: row; }\n  @media (max-width: 600px) {\n    :host {\n      flex-direction: column; } }\n  .video {\n  display: flex;\n  flex-direction: column;\n  height: 100vh;\n  width: -webkit-fit-content;\n  width: -moz-fit-content;\n  width: fit-content; }\n  @media (max-width: 600px) {\n    .video {\n      width: 100%; } }\n  .video .content {\n    background: #1F2C3C;\n    padding: 12px; }\n  .video .content .reposition {\n      background: #2FB698;\n      border: 0;\n      border-radius: 4px;\n      color: white;\n      display: block;\n      font-size: 18px;\n      line-height: 40px;\n      margin: 0 auto;\n      padding: 0;\n      width: 190px; }\n  .video .content .player {\n      width: 100%;\n      height: -webkit-fit-content;\n      height: -moz-fit-content;\n      height: fit-content;\n      margin-top: 24px;\n      position: relative; }\n  .video .content .player img {\n        width: 100%;\n        height: auto; }\n  .video .content .player .add-subtitle {\n        color: white;\n        font-family: 'HelveticaNeue Bold';\n        font-size: 18px;\n        position: absolute;\n        bottom: 65px;\n        width: 100%;\n        text-align: center;\n        left: 0; }\n  .video .options {\n    padding: 12px; }\n  .video .options select {\n      -webkit-appearance: none;\n      appearance: none;\n      -moz-appearance: none;\n      background: transparent;\n      background-image: url('drop-down.png');\n      background-repeat: no-repeat;\n      background-position: right center;\n      border: 0;\n      font-size: 14px;\n      min-width: 60px; }\n  .video .options select.font-sizes {\n        margin-left: 16px; }\n  .video .options .btn-toolbar {\n      border-radius: 4px;\n      cursor: pointer;\n      display: inline-block;\n      font-size: 14px;\n      line-height: 24px;\n      margin: 0 4px;\n      padding: 0;\n      text-align: center; }\n  .video .options .btn-toolbar.background {\n        background: #B8E986;\n        border: 1px solid #B8E986;\n        width: 26px; }\n  .video .options .btn-toolbar.bold {\n        background: transparent;\n        font-family: 'HelveticaNeue Bold';\n        font-size: 20px; }\n  .video .options .btn-toolbar.foreground {\n        background: #FFF300;\n        border: 1px solid black;\n        width: 26px; }\n  .video .options .btn-toolbar.italic {\n        background: transparent;\n        font-family: 'HelveticaNeue Bold';\n        font-size: 20px;\n        font-style: italic;\n        width: 26px; }\n  .video .options .btn-toolbar.spaceing {\n        background: transparent;\n        border: 0; }\n  .video .options .separator {\n      display: inline-block;\n      margin: 0 8px; }\n  .video .options .separator:before {\n        content: '|'; }\n  .video .sizes {\n    background: #1F2C3C;\n    display: flex;\n    flex-direction: column;\n    flex-grow: 1;\n    padding: 12px; }\n  .video .sizes * {\n      line-height: 38px; }\n  .video .sizes .types {\n      flex-grow: 1; }\n  .video .sizes .types label {\n        color: white;\n        font-size: 14px;\n        padding-right: 12px; }\n  .video .sizes .types .btn-outline {\n        background: transparent;\n        border: 1px solid #FFFFFF;\n        border-radius: 4px;\n        color: white;\n        font-size: 9px;\n        margin: 0 3px;\n        padding: 0; }\n  .video .sizes .types .btn-outline.active {\n          border: 1px solid #50E3C2; }\n  .video .sizes .types .btn-outline.nine-sixteen {\n          width: 22px; }\n  .video .sizes .types .btn-outline.one-one {\n          width: 38px; }\n  .video .sizes .types .btn-outline.sixteen-nine {\n          width: 67px; }\n  .video .sizes .complete {\n      background: #FF1569;\n      border: 0;\n      border-radius: 4px;\n      bottom: 16px;\n      color: white;\n      display: block;\n      font-family: \"HelveticaNeue Bold\";\n      font-size: 24px;\n      line-height: 59px;\n      margin: 0 8px;\n      width: calc(100% - 16px); }\n  .subtitles {\n  flex-grow: 1;\n  display: flex;\n  flex-direction: column;\n  height: 100vh;\n  padding: 16px 12px; }\n  @media (max-width: 600px) {\n    .subtitles {\n      width: 100%;\n      height: -webkit-fit-content;\n      height: -moz-fit-content;\n      height: fit-content; } }\n  .subtitles .video-options {\n    display: block;\n    height: -webkit-fit-content;\n    height: -moz-fit-content;\n    height: fit-content;\n    padding: 16px 14px; }\n  .subtitles .video-options h2 {\n      font-family: 'HelveticaNeue Bold';\n      font-size: 18px; }\n  .subtitles .video-options .actions {\n      margin-bottom: 20px; }\n  .subtitles .video-options .actions button {\n        background: #989898;\n        border: 0;\n        border-radius: 4px;\n        color: white;\n        display: inline-block;\n        font-family: 'HelveticaNeue Regular';\n        font-size: 14px;\n        line-height: 23px;\n        margin: 0 2px;\n        padding: 9px 12px;\n        position: relative;\n        width: 49px; }\n  .subtitles .video-options .actions button i {\n          font-size: 20px; }\n  .subtitles .video-options .actions button.play {\n          background: #FF1569;\n          width: 86px; }\n  .subtitles .video-options .actions p-slider .slider-width .ui-slider-range {\n        background: transparent !important; }\n  .subtitles .video-options .running {\n      color: #6E6E6E;\n      font-size: 14px;\n      margin-left: 16px; }\n  .subtitles .content {\n    display: block;\n    margin-top: 20px;\n    flex-grow: 1;\n    overflow-y: auto; }\n  @media (max-width: 600px) {\n      .subtitles .content {\n        overflow-y: hidden;\n        flex-grow: unset; } }\n  .subtitles .subtitle {\n    display: block;\n    height: -webkit-fit-content;\n    height: -moz-fit-content;\n    height: fit-content;\n    padding: 16px 14px; }\n  .subtitles .subtitle.disabled {\n      background: #D8D8D8;\n      border: 1px dotted #818181;\n      border-radius: 8px;\n      opacity: .31;\n      pointer-events: none; }\n  .subtitles .subtitle .title {\n      display: flex;\n      flex-direction: row;\n      margin-bottom: 16px;\n      width: 100%; }\n  .subtitles .subtitle .period {\n      align-items: flex-start;\n      display: flex;\n      flex-direction: row;\n      margin-top: 16px; }\n  .subtitles .subtitle .period .start .time, .subtitles .subtitle .period .end .time {\n        border: 1px solid #c6c5c5;\n        border-radius: 4px;\n        display: block;\n        font-size: 14px;\n        line-height: 16px;\n        padding: 2.5px 8px;\n        text-align: center;\n        width: 72px; }\n  .subtitles .subtitle .period .start label, .subtitles .subtitle .period .end label {\n        color: #797979;\n        display: block;\n        font-size: 12px;\n        line-height: 14px;\n        margin-top: 4px;\n        text-align: center; }\n  .subtitles .subtitle .period .divider {\n        font-size: 18px;\n        padding: 0px 8px; }\n  .subtitles .subtitle-add {\n    position: relative;\n    display: block; }\n  .subtitles .subtitle-add .btn-add {\n      background: #00D060;\n      border: 1px solid #FFFFFF;\n      border-radius: 5px;\n      color: white;\n      font-family: 'HelveticaNeue Bold';\n      font-size: 13px;\n      height: 41px;\n      left: 50%;\n      line-height: 16px;\n      position: absolute;\n      top: 50%;\n      -webkit-transform: translate(-50%, -50%);\n              transform: translate(-50%, -50%);\n      width: 198px; }\n  .complete-modal {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  z-index: 100;\n  background: #1B2126; }\n  .complete-modal .modal-header {\n    background: #1F2C3C;\n    height: 70px;\n    position: relative;\n    top: 0;\n    left: 0;\n    width: 100vw; }\n  .complete-modal .modal-header .actions {\n      float: right;\n      padding: 0px 20px; }\n  .complete-modal .modal-header .actions button {\n        background: transparent;\n        border: 0;\n        color: #757F8B;\n        font-family: 'HelveticaNeue Medium';\n        font-size: 10px;\n        height: 70px;\n        margin: 0px 10px; }\n  .complete-modal .modal-header .actions button i {\n          color: white;\n          display: block;\n          font-size: 33px; }\n  .complete-modal .modal-header .actions button:hover i {\n          color: #4A90E2; }\n  .complete-modal .player {\n    max-width: 800px;\n    max-height: calc(100% - 70px);\n    width: 100%;\n    height: -webkit-fit-content;\n    height: -moz-fit-content;\n    height: fit-content;\n    position: relative;\n    top: calc(50% - 35px);\n    left: 50%;\n    -webkit-transform: translate(-50%, -50%);\n            transform: translate(-50%, -50%); }\n  .complete-modal .player img {\n      width: 100%;\n      height: 100%;\n      -o-object-fit: contain;\n         object-fit: contain; }\n  .complete-modal .player .add-subtitle {\n      display: block;\n      text-align: center;\n      color: white;\n      font-family: 'HelveticaNeue Bold';\n      font-size: 18px;\n      margin-top: -16%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var EditorComponent = /** @class */ (function () {
    ...
    EditorComponent.prototype.addSubtitle = function () {
        var newSub = {
    ...
    EditorComponent.prototype.deleteSubtitle = function (id) {
        var index = this.subtitles.findIndex(function (item) { return item.id === id; });
        this.subtitles.splice(index, 1);
    };
    EditorComponent.prototype.closeCompleteModal = function () {
        this.isShowCompleteModal = false;
    };
    EditorComponent.prototype.showCompleteModal = function () {
...
/* harmony import */ var _editor_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.component */ "./src/app/pages/editor/editor.component.ts");
/* harmony import */ var _editor_routes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.routes */ "./src/app/pages/editor/editor.routes.ts");
/* harmony import */ var primeng_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! primeng/slider */ "./node_modules/primeng/slider.js");
/* harmony import */ var primeng_slider__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(primeng_slider__WEBPACK_IMPORTED_MODULE_4__);
    ...
    EditorModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                _editor_routes__WEBPACK_IMPORTED_MODULE_3__["EditorRoutingModule"],
...
/***/ "./src/app/pages/editor/editor.routes.ts":
/*!***********************************************!*\
  !*** ./src/app/pages/editor/editor.routes.ts ***!
  \***********************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _videotime_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./videotime.pipe */ "./src/app/pipes/videotime.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PipesModule = /** @class */ (function () {
    ...
    PipesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _videotime_pipe__WEBPACK_IMPORTED_MODULE_2__["VideoTimePipe"]
            ],
...
/***/ "./src/app/pipes/videotime.pipe.ts":
/*!*****************************************!*\
  !*** ./src/app/pipes/videotime.pipe.ts ***!
  \*****************************************/
/*! exports provided: VideoTimePipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VideoTimePipe", function() { return VideoTimePipe; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var VideoTimePipe = /** @class */ (function () {
    function VideoTimePipe() {
    }
    VideoTimePipe.prototype.transform = function (input) {
        var seconds = Math.floor(input / 100);
        var miliSeconds = input % 100;
        var videoTime = '';
        if (seconds < 10) {
            videoTime = "0" + seconds;
        }
    ...
    VideoTimePipe = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"])({
            name: 'videotime'
        })
    ], VideoTimePipe);
    return VideoTimePipe;
}());
